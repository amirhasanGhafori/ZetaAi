...
//Imgae Genetation Message Controller
export const imageMessageController = async (req, res) => {
    try {
        ...
        const generatedImageUrl = `${process.env.IMAGEKIT_URL_ENDPOINT}/ik-genimg-prompt-${endcodedPrompt}/zetaai/${Date.now()}.png?tr=w-800,h-800`;
        ...
        //upload to imagekit media librery
